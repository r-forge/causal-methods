...
For example, the method has removed all knots from `re75` for
the treated group and kept two knots for the control group. We can then
...
model. In this case, we see FTLSE as selection method and AIC as
criterion.

...
class `cslseKnots` and a list of objects of class `slseKnots`. 

it
contains all knots for the treated and nontreated. Its print method
shows all knots for both groups. To print the knots of a specific
group, just specify which one we want to see. For example, to print
the knots of the treated we proceed as follows:
...
In the following example, we see BSLSE as selection method and BIC as
